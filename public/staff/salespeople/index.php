...
<div id="main-content">
  ...
  <?php
    ...
    while($salesperson = db_fetch_assoc($salespeople_result)) {
      echo "<tr>";
      echo "<td>" . h(s($salesperson['first_name'])) . "</td>";
      echo "<td>" . h(s($salesperson['last_name'])) . "</td>";
      echo "<td>";
      echo "<a href=\"show.php?id=" . h(s(u($salesperson['id']))) . "\">Show</a>";
      echo "</td>";
      echo "<td>";
      echo "<a href=\"edit.php?id=" . h(s(u($salesperson['id']))) . "\">Edit</a>";
      echo "</td>";
      echo "</tr>";
